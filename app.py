...
def main():
    ...
    st.markdown('<h2 style="color: #0047AB;">Predict the Air Quality Index in Bengaluru</h2>', unsafe_allow_html=True)
    ...
    st.markdown('<h3 style="color: #0047AB;">Enter the Pollutant Concentrations</h3>', unsafe_allow_html=True)
